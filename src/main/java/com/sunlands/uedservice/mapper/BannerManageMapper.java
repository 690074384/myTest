...
public interface BannerManageMapper {
     ...
     * @return
     */
    @Select("select id,title,picture_url as pictureUrl,type,creator,updater,create_time as createTime,update_time as updateTime,sequence from tb_banner_manage where delete_flag = 0 order by sequence limit #{param1},#{param2}")
