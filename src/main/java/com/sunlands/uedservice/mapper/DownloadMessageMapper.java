...
public interface DownloadMessageMapper {
     ...
     * @return
     */
    @Select("select id,picture_url as pictureUrl,title,attachment_url as attachmentUrl,type,creator,updater,create_time as createTime,update_time as updateTime,sequence from tb_download_message where id = #{id} and delete_flag = 0")
     ...
     * @return
     */
    @Select("select id,picture_url as pictureUrl,title,attachment_url as attachmentUrl,type,creator,updater,create_time as createTime,update_time as updateTime,sequence from tb_download_message where delete_flag = 0 order by update_time desc limit #{param1},#{param2}")
     ...
     * @return
     */
    @Select("select id,picture_url as pictureUrl,title,attachment_url as attachmentUrl,type,creator,updater,create_time as createTime,update_time as updateTime,sequence from tb_download_message where id = #{id}")
