...
public interface PictureWordMapper {
     ...
     * @return
     */
    @Select("select id,picture_url as pictureUrl,title,article,type,creator,updater,create_time as createTime,update_time as updateTime,sequence from tb_picture_word where delete_flag = 0 order by update_time desc limit #{param1},#{param2}")
